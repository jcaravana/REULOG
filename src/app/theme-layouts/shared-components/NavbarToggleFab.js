...
function NavbarToggleFab(props) {
  ...
  return (
    <Root
      ...
      className="bg-red-A700 text-red"
    >
      <Fab
        className={clsx('button', 'bg-red-A700', ' text-white hover:bg-indigo-900')}
        onClick={(ev) => dispatch(isMobile ? navbarToggleMobile() : navbarToggle())}
      >
        <FuseSvgIcon color="action" className="button-icon text-white">
